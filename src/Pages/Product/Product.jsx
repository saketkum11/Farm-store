          ...
          <div className="flex flex-column bg-black-0 wt-100 position-rel">
            ...
            <div className="wt-100 m-t-8">
              <div className=" flex flex-column items-center wt-100 ">
                ...
                <button className="wt-100 border-none cursor pd-y-3 m-t-5 text-color-0 bg-red-7 text-dec " onClick={clickHandler}
                 >Added
                  to cart</button>
              </div>
            </div>
          ...
          <div className="flex flex-column bg-black-0 wt-100 position-rel">
            ...
            <div className="wt-100 m-t-8">
              <div className=" flex flex-column items-center wt-100 ">
                <span className="text-xm text-light">Fruit</span>
                <small className="text-bold text-xm">₹250</small>
                <button className="wt-100 border-none cursor pd-y-3 m-t-5 text-color-0 bg-black-5 text-dec " onClick={clickHandler}>Add
                  to cart</button>
              </div>
            </div>
          </div>
